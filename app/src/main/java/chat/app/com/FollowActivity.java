...
public class FollowActivity extends AppCompatActivity {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				userposts.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						listview1.setAdapter(new Listview1Adapter(user_data));
	...
	private void initializeLogic() {
		...
		list = "userposts/".concat(getIntent().getStringExtra("uid").concat("/followers"));
		userposts = _firebase.getReference(list);
		userposts.addChildEventListener(_userposts_child_listener);
	}
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.follows, null);
			}

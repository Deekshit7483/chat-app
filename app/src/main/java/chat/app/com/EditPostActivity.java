...
public class EditPostActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				post.child(getIntent().getStringExtra("key")).updateChildren(map);
				map.clear();
				finish();
			}
		});
	...
	private void initializeLogic() {
		edittext1.setText(getIntent().getStringExtra("caption"));
		switch1.setText(getIntent().getStringExtra("comment"));
		Glide.with(getApplicationContext()).load(Uri.parse(getIntent().getStringExtra("img"))).into(imageview1);
		if (getIntent().getStringExtra("comment").equals("Comment on")) {
			switch1.setChecked(true);
		}
		else {
			if (getIntent().getStringExtra("comment").equals("Comment off")) {
				switch1.setChecked(false);
			}
		}
		_SetBackground(button1, 20, 15, "#009688", true);
	}
